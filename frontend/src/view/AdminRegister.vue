    ...
    <div class="auth-wrapper">
        <div class="auth-inner">
            <form @submit.prevent="handleSubmit">
                ...
                <a href="/admin/login" class="link">Click Here to Login</a>
    ...
    setup() {
        ...
        const handleSubmit = async () => {
            ...
            try {
                ...
                if(response.data.message == "There is already one admin present, you cannot signup as admin") {
                    alert("There is already one admin present, you cannot signup as admin")
                }
                else{
